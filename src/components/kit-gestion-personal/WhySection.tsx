...
const reasons = [
  {
    ...
    desc: 'No son plantillas de RRHH genericas. Estan pensadas para restaurantes, hoteles y catering: turnos partidos, servicios, cocina, sala, extras de fin de semana.',
  },
  {
    icon: Calculator,
    title: 'Formulas Reales',
    desc: 'Calculo automatico de coste laboral, horas extra segun convenio, ratios covers/empleado y prevision de plantilla por servicio. No es teoria: son numeros.',
  },
  {
    icon: ShieldCheck,
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]">
        <img src="/lovable-uploads/ai-gallery/tareas-gestion-personal-oficina.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
