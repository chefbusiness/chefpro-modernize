...
const stripeLink = import.meta.env.VITE_STRIPE_PAYMENT_LINK_TAREAS_CHEF_PRIVADO || '#comprar';
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto text-center z-10">
        <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">Tú Eres la Cocina, el Camarero, el Logístico y el Contable</h2>
        <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">9 checklists que organizan las 10 áreas críticas de tu negocio como chef privado. Por menos de lo que cobras por una guarnición.</p>
        <div className="bg-white/5 border border-[#FFD700]/20 rounded-2xl p-8 md:p-10 backdrop-blur-sm">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            <span className="text-xl text-gray-500 line-through">€85</span>
            <span className="text-4xl md:text-5xl font-extrabold text-[#FFD700]">€18</span>
          </div>
