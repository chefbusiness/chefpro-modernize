...
const stripeLink = import.meta.env.VITE_STRIPE_PAYMENT_LINK_PLAN_FOOD_TRUCK || '#comprar';
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.06]">
        <img src="/lovable-uploads/ai-gallery/plan-food-truck-hero.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
      ...
      <div className="relative max-w-3xl mx-auto text-center z-10">
        <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">Es Hora de Hacer Realidad tu <span className="text-[#FFD700]">Food Truck</span></h2>
        <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">No dejes pasar esta oportunidad. Únete a emprendedores que ya montaron su food truck con un plan financiero profesional, bajo riesgo y rentabilidad rápida.</p>
