import { ClipboardCheck, Beer, Sandwich, RefreshCw } from 'lucide-react';
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]">
        <img src="/lovable-uploads/ai-gallery/tareas-bar-barra.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
        ...
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              No son plantillas genéricas. Son checklists diseñados por un profesional con 29 años en alta hostelería y experiencia en tapas bars, gastrobars y barras de pinchos.
            </p>
          </div>
        </FadeIn>
