...
const stripeLink = import.meta.env.VITE_STRIPE_PAYMENT_LINK_PLAN_CAFETERIA || '#comprar';
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.06]">
        <img src="/lovable-uploads/ai-gallery/plan-cafeteria-hero.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
      ...
      <div className="relative max-w-3xl mx-auto text-center z-10">
        <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">Es Hora de Hacer Realidad tu <span className="text-[#FFD700]">Cafetería</span></h2>
        <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">No dejes pasar esta oportunidad. Únete a propietarios que ya abrieron su cafetería o brunch con un plan financiero profesional y un checklist de apertura completo.</p>
        <div className="bg-white/5 border border-[#FFD700]/20 rounded-2xl p-8 md:p-10 backdrop-blur-sm">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <span className="text-4xl md:text-5xl font-extrabold text-[#FFD700]">€29</span>
          </div>
