  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.06]">
        <img src="/lovable-uploads/ai-gallery/guia-gastro-sala.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
      ...
      <div className="relative max-w-3xl mx-auto text-center z-10">
        ...
        <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">Todo lo que necesitas por menos de lo que cuesta una hora de consultoría.</p>
        <div className="bg-white/5 border border-[#FFD700]/20 rounded-2xl p-8 md:p-10 backdrop-blur-sm">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            <span className="text-xl text-gray-500 line-through">220 EUR</span>
            <span className="text-4xl md:text-5xl font-extrabold text-[#FFD700]">85 EUR</span>
          </div>
