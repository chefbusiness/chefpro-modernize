...
const reasons = [
  {
    ...
    desc: 'Chef desde los 17 años y consultor desde 2010, 200+ aperturas asesoradas, clientes con Estrella Michelin y Soles Repsol. Experiencia real, no teoría de manual.',
  },
  {
    icon: Calculator,
