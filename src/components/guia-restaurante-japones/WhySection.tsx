...
const reasons = [
  {
    ...
    desc: 'Chef desde los 17 años y consultor desde 2010, 200+ aperturas asesoradas. Incluye proveedores reales de pescado sashimi-grade y productos japoneses en España.',
  },
  {
    icon: Calculator,
    title: 'Números Reales, No Fantasía',
    desc: 'Inversión real (250K-500K€), food cost 30-35%, márgenes sake/whisky 75-85%, break-even calculado y 3 escenarios.',
  },
  {
    icon: FileSpreadsheet,
    title: 'Incluye Plantillas por Valor de 80€+',
    desc: 'Plan financiero, escandallos de sashimi/ramen/yakitori, menú engineering, Gantt y más — todo en Excel.',
  },
  {
    icon: RefreshCw,
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]">
        <img src="/lovable-uploads/ai-gallery/guia-restaurante-japones-cocina.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
