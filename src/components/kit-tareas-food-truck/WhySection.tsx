import { ClipboardCheck, ShieldCheck, MapPin, RefreshCw } from 'lucide-react';
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]">
        <img src="/lovable-uploads/ai-gallery/use-case-food-truck-team.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
        ...
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              No son plantillas genéricas. Son checklists diseñados por un chef en cocina desde los 17 años y consultor gastronómico desde 2010 y experiencia asesorando food trucks, street food y cocinas móviles de eventos.
            </p>
          </div>
        </FadeIn>
