...
const stripeLink = import.meta.env.VITE_STRIPE_PAYMENT_LINK_TAREAS_FOOD_TRUCK || '#comprar';
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.06]">
        <img src="/lovable-uploads/ai-gallery/use-case-food-truck-hero.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
      ...
      <div className="relative max-w-3xl mx-auto text-center z-10">
        <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">Es Hora de Organizar las Operaciones de tu Food Truck</h2>
        <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">9 checklists + 2 bonus que organizan las áreas críticas de tu food truck o cocina móvil: setup, teardown, vehículo, APPCC móvil, permisos, eventos y perfiles. No dejes pasar esta oportunidad.</p>
        <div className="bg-white/5 border border-[#FFD700]/20 rounded-2xl p-8 md:p-10 backdrop-blur-sm">
          ...
          <a href={stripeLink} className="inline-block w-full md:w-auto px-10 py-4 bg-[#FFD700] text-black font-bold text-lg rounded-xl hover:bg-[#FFD700]/90 transition-all hover:scale-[1.02] active:scale-[0.98]">
            SÍ, QUIERO EL KIT DE TAREAS FOOD TRUCK — €12
          </a>
