...
const stripeLink = import.meta.env.VITE_STRIPE_PAYMENT_LINK_ESCANDALLOS || '#comprar';
      ...
      <div className="relative max-w-lg mx-auto z-10">
        <div className="bg-white/5 border-2 border-[#FFD700]/50 rounded-2xl p-8 md:p-10 text-center backdrop-blur-sm">
          <div className="flex items-center justify-center gap-4 mb-3">
            ...
            <span className="px-3 py-1 rounded-full bg-[#FFD700]/20 text-[#FFD700] text-sm font-bold">-75%</span>
          </div>
          <p className="text-gray-400 text-sm mb-6">Precio especial de lanzamiento — 75% de descuento</p>
          <a
            href={stripeLink}
