import { ClipboardCheck, Flame, Users, RefreshCw } from 'lucide-react';
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]">
        <img src="/lovable-uploads/ai-gallery/tareas-restaurante-partidas.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
