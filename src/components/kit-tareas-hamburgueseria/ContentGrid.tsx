...
const templates = [
  { icon: DoorOpen, title: 'Apertura y Cierre', desc: '6 checklists: apertura y cierre de plancha/grill, freidora, línea de montaje, sala y barra. Cada tarea con responsable, hora límite y firma. ~80 tareas pre-rellenadas.' },
  { icon: Flame, title: 'Tareas de Plancha y Grill', desc: 'Encendido de plancha, temperatura óptima, limpieza de superficie, test de punto de carne, gestión de smash burgers, control de tiempos por grosor.' },
  ...
  { icon: Users, title: 'Tareas por Perfil', desc: 'Checklists personalizados para: parrillero/grill master, cocinero de línea, freidurista, encargado/a y camarero/a.' },
  { icon: CalendarDays, title: 'Semanales y Mensuales', desc: 'Limpieza profunda semanal por zona, revisión FIFO de cámaras, mantenimiento mensual de plancha, freidora y campana extractora.' },
  { icon: PartyPopper, title: 'Eventos y Festivos', desc: 'Checklist pre-evento (48h→día), noche de burger especial, festivos con menú limitado, gestión de picos de delivery.' },
  ...
  { icon: Megaphone, title: 'BONUS: Briefing Servicio', desc: 'Plantilla de briefing pre-servicio: reservas, burger especial del día, alérgenos, equipo del turno. Imprime y pega en cocina.' },
