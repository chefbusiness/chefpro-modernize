...
const reasons = [
  {
    ...
    desc: 'Chef desde los 17 años y consultor desde 2010, 200+ aperturas asesoradas. Incluye proveedores reales de productos mexicanos en España.',
  },
  {
    icon: Calculator,
    title: 'Números Reales, No Fantasía',
    desc: 'Inversión real (120K-280K€), food cost 28-33%, márgenes en tequila/mezcal del 75-80%, break-even calculado.',
  },
  {
    icon: FileSpreadsheet,
    title: 'Incluye Plantillas por Valor de 80€+',
    desc: 'Plan financiero, escandallos de tacos/burritos/guacamole, menú engineering, Gantt y más — todo en Excel.',
  },
  {
    icon: RefreshCw,
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]">
        <img src="/lovable-uploads/ai-gallery/guia-mexicano-cocina.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
