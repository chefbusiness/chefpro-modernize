...
const stripeLink = import.meta.env.VITE_STRIPE_PAYMENT_LINK_GUIA_DARK_KITCHEN || '#comprar';
    ...
    <section className="relative px-4 pt-8 pb-16 md:pt-12 md:pb-24 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center z-10">
        ...
        <span className="inline-block mb-6 px-4 py-1.5 rounded-full bg-red-500/10 border border-red-500/30 text-red-400 text-sm font-medium animate-fade-in">
          Las dark kitchens crecen un 25% anual en España — pero el 40% cierra el primer año
        </span>

        <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
          Cómo Montar una <span className="text-[#FFD700]">Dark Kitchen</span>
          <span className="block text-2xl md:text-4xl lg:text-5xl mt-2 text-gray-200">
            De la Idea a la Primera Entrega en 90 Días
          </span>
        </h1>

        <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed">
          Guía completa con 12 capítulos, 3 checklists Excel, calculadora de viabilidad e infografías. Todo lo que necesitas para abrir tu dark kitchen sin cometer los errores que cuestan miles de euros.
        </p>
        ...
        <div className="inline-block bg-white/5 border border-[#FFD700]/20 rounded-2xl p-6 md:p-8 backdrop-blur-sm">
          <div className="flex items-center justify-center gap-4 mb-3">
            <span className="text-2xl text-gray-500 line-through">49 EUR</span>
            <span className="text-5xl md:text-6xl font-extrabold text-[#FFD700]">14 EUR</span>
            <span className="px-3 py-1 rounded-full bg-[#FFD700]/20 text-[#FFD700] text-sm font-bold">-71%</span>
          </div>
