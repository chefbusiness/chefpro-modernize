      ...
      <div className="relative max-w-4xl mx-auto text-center z-10">
        ...
        <div className="inline-block bg-white/5 border border-[#FFD700]/20 rounded-2xl p-6 md:p-8 backdrop-blur-sm">
          <div className="flex items-center justify-center gap-4 mb-3">
            <span className="text-2xl text-gray-500 line-through">90 EUR</span>
            <span className="text-5xl md:text-6xl font-extrabold text-[#FFD700]">24 EUR</span>
            <span className="px-3 py-1 rounded-full bg-[#FFD700]/20 text-[#FFD700] text-sm font-bold">-73%</span>
          </div>
