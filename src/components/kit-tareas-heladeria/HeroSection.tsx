...
const stripeLink = import.meta.env.VITE_STRIPE_PAYMENT_LINK_TAREAS_HELADERIA || '#comprar';
    ...
    <section className="relative px-4 pt-8 pb-16 md:pt-12 md:pb-24 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center z-10">
        ...
        <span className="inline-block mb-6 px-4 py-1.5 rounded-full bg-[#FFD700]/10 border border-[#FFD700]/30 text-[#FFD700] text-sm font-medium animate-fade-in">
          Lo que el software de gestión cobra €40/mes, tú lo tienes por €12 — para siempre
        </span>

        <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
          Kit de Tareas <span className="text-[#FFD700]">Recurrentes</span>
          <span className="block text-2xl md:text-4xl lg:text-5xl mt-2 text-gray-200">
            Heladería Artesanal — Checklists por Turno, Zona y Perfil
          </span>
        </h1>

        <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed">
          9 plantillas Excel pre-rellenadas para tu heladería artesanal: producción, vitrina, servicio, gestión y temporada. Imprime, delega al equipo, firma y archiva.
        </p>
        ...
        <div className="inline-block bg-white/5 border border-[#FFD700]/20 rounded-2xl p-6 md:p-8 backdrop-blur-sm">
          <div className="flex items-center justify-center gap-4 mb-3">
            <span className="text-2xl text-gray-500 line-through">€39</span>
            <span className="text-5xl md:text-6xl font-extrabold text-[#FFD700]">€12</span>
            <span className="px-3 py-1 rounded-full bg-[#FFD700]/20 text-[#FFD700] text-sm font-bold">-69%</span>
          </div>
