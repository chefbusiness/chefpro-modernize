  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.06]">
        <img src="/lovable-uploads/ai-gallery/tareas-catering-hero.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
      ...
      <div className="relative max-w-3xl mx-auto text-center z-10">
        <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">Deja de Improvisar en Cada Evento</h2>
        <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">9 checklists operativos para catering por menos de lo que cuesta una hora de consultoría.</p>
