import { FileText, BarChart3, ShieldCheck, Banknote } from 'lucide-react';
import FadeIn from '../ebook/FadeIn';

const reasons = [
  {
    icon: FileText,
    title: 'Plan DOCX + Excel Profesional',
    desc: 'Documento Word de 10 secciones con resumen ejecutivo, DAFO, análisis de mercado y plan financiero. Excel con fórmulas activas que recalculan al cambiar cifras.',
  },
  {
    icon: BarChart3,
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]">
        <img src="/lovable-uploads/ai-gallery/plan-tapas-bar-cocina.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
