        ...
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              Todo lo que necesitas saber para montar tu restaurante peruano en España, escrito por un chef en cocina desde los 17 años y consultor gastronómico desde 2010.
            </p>
          </div>
        </FadeIn>
        <FadeIn>
