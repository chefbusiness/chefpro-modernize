  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.06]">
        <img src="/lovable-uploads/ai-gallery/guia-peruano-sala.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
      ...
      <div className="relative max-w-3xl mx-auto text-center z-10">
        ...
        <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">Todo lo que necesitas por menos de lo que cuesta un ceviche para cuatro.</p>
