...
const bonuses = [
  {
    ...
    value: '49 EUR',
    desc: 'Plantilla rellenable con estructura profesional para presentar a bancos e inversores. Incluye sección específica de cocina peruana y proveedores de importación.',
    image: '/lovable-uploads/ai-gallery/guia-peruano-hero.jpg',
  },
  {
    icon: BookOpen,
    label: 'BONUS 2',
    title: 'Manual de Operaciones Peruano',
    value: '39 EUR',
    desc: 'Protocolo completo: cevichería, anticuchería, barra de piscos, preparación de leche de tigre, delivery, eventos temáticos (Fiestas Patrias).',
    image: '/lovable-uploads/ai-gallery/guia-peruano-sala.jpg',
  },
  {
    icon: ClipboardCheck,
    label: 'BONUS 3',
    title: 'Checklist Equipamiento Cocina Peruana',
    value: '29 EUR',
    desc: '35 ítems específicos: mesa refrigerada ceviche, wok industrial, parrilla anticuchos, vitrina piscos, molino de ajíes.',
    image: '/lovable-uploads/ai-gallery/guia-peruano-cocina.jpg',
  },
  {
    icon: CalendarRange,
    label: 'BONUS 4',
    ...
    value: '24 EUR',
    desc: 'Fases específicas para peruano: importación de productos, diseño de cevichería, formación en cocina peruana, soft opening.',
    image: '/lovable-uploads/ai-gallery/guia-peruano-barra.jpg',
  },
  {
    icon: PieChart,
    label: 'BONUS 5',
    title: 'Escandallos: 15 Recetas Base Peruanas',
    value: '19 EUR',
    desc: 'Fichas técnicas con food cost real: ceviche clásico, lomo saltado, causa limeña, ají de gallina, anticuchos, suspiro limeño.',
    image: '/lovable-uploads/ai-gallery/guia-peruano-plato.jpg',
  },
];
