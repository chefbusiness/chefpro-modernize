...
const reasons = [
  {
    ...
    desc: 'Chef desde los 17 años y consultor desde 2010, 200+ aperturas asesoradas. Incluye proveedores reales de productos peruanos en España.',
  },
  {
    icon: Calculator,
    title: 'Números Reales, No Fantasía',
    desc: 'Inversión real (130K-300K€), food cost 28-32%, márgenes pisco sour 78%, break-even calculado y 3 escenarios.',
  },
  {
    icon: FileSpreadsheet,
    title: 'Incluye Plantillas por Valor de 80€+',
    desc: 'Plan financiero, escandallos de ceviche/lomo saltado/causa, menú engineering, Gantt y más — todo en Excel.',
  },
  {
    icon: RefreshCw,
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]">
        <img src="/lovable-uploads/ai-gallery/guia-peruano-cocina.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
