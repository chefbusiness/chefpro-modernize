      ...
      <div className="max-w-5xl mx-auto">
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg">Además de las 15 plantillas, recibirás estos recursos adicionales — valorados en €18</p>
          </div>
        </FadeIn>
        ...
        <FadeIn>
          <div className="text-center bg-white/5 border border-[#FFD700]/30 rounded-2xl p-8">
            ...
            <p className="text-3xl text-gray-500 line-through mb-1">€95</p>
            <p className="text-5xl md:text-6xl font-extrabold text-[#FFD700] mb-2">€18,50</p>
            <p className="text-[#FFD700] font-bold text-lg">¡Ahorra €76,50 HOY!</p>
          </div>
        </FadeIn>
      </div>
    </section>
