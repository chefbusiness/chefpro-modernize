...
const stripeLink = import.meta.env.VITE_STRIPE_PAYMENT_LINK_TAREAS_HOTEL_V2 || '#comprar';
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.06]">
        <img src="/lovable-uploads/ai-gallery/tareas-hotel-hero.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
      ...
      <div className="relative max-w-3xl mx-auto text-center z-10">
        <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">Estandariza las Operaciones de Todo Tu Hotel</h2>
        <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">46 checklists operativos en 15 plantillas para 11 departamentos, por menos de lo que cuesta una hora de consultoría.</p>
        <div className="bg-white/5 border border-[#FFD700]/20 rounded-2xl p-8 md:p-10 backdrop-blur-sm">
          ...
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <span className="text-4xl md:text-5xl font-extrabold text-[#FFD700]">€18,50</span>
          </div>
          <a href={stripeLink} className="inline-block w-full md:w-auto px-10 py-4 bg-[#FFD700] text-black font-bold text-lg rounded-xl hover:bg-[#FFD700]/90 transition-all hover:scale-[1.02] active:scale-[0.98]">
            SÍ, QUIERO EL KIT COMPLETO — €18,50
          </a>
