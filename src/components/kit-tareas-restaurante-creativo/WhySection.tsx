        ...
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              No son plantillas genericas. Son checklists disenados por un chef en cocina desde los 17 años, consultor gastronómico desde 2010 y especializado en restauración creativa.
            </p>
          </div>
        </FadeIn>
