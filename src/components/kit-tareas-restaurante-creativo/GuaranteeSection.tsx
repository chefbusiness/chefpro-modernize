      ...
      <div className="max-w-3xl mx-auto text-center">
        <FadeIn>
          ...
          <p className="text-gray-400 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
            Si los checklists no te ayudan a organizar mejor las operaciones de tu restaurante creativo, te devolvemos el 100% de tu dinero. Sin preguntas, sin complicaciones.
          </p>
        </FadeIn>
        <FadeIn delay={150}>
