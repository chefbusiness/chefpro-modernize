...
const stripeLink = import.meta.env.VITE_STRIPE_PAYMENT_LINK_GUIA_RESTAURANTE_NIKKEI || '#comprar';
    ...
    <section className="relative px-4 pt-8 pb-16 md:pt-12 md:pb-24 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center z-10">
        ...
        <span className="inline-block mb-6 px-4 py-1.5 rounded-full bg-red-500/10 border border-red-500/30 text-red-400 text-sm font-medium animate-fade-in">
          Cocina nikkei: la fusión peruano-japonesa más deseada del mundo — tendencia premium alcista en España
        </span>

        <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
          Cómo Montar un <span className="text-[#FFD700]">Restaurante Nikkei</span>
          <span className="block text-2xl md:text-4xl lg:text-5xl mt-2 text-gray-200">
            60 Plazas · Guía Completa España
          </span>
        </h1>

        <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed">
          Guía completa con 20 capítulos, 60+ páginas, 9 plantillas Excel, 6 checklists, business plan modelo y manual de operaciones. Todo para abrir tu barra de tiraditos, cevichería nikkei, robata nikkei u omakase peruano-japonés en España. Referentes: Nobu, Maido, Osaka, Pakta.
        </p>
        ...
        <div className="inline-block bg-white/5 border border-[#FFD700]/20 rounded-2xl p-6 md:p-8 backdrop-blur-sm">
          <div className="flex items-center justify-center gap-4 mb-3">
            <span className="text-2xl text-gray-500 line-through">180 EUR</span>
            <span className="text-5xl md:text-6xl font-extrabold text-[#FFD700]">65 EUR</span>
            <span className="px-3 py-1 rounded-full bg-[#FFD700]/20 text-[#FFD700] text-sm font-bold">-64%</span>
          </div>
          <p className="text-sm text-gray-400 mb-5">Precio de lanzamiento — ahorra 115 EUR</p>
          <a
            href={stripeLink}
