      ...
      <div className="max-w-3xl mx-auto text-center">
        <FadeIn>
          ...
          <p className="text-gray-400 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
            Si la guía no te aporta valor real para montar tu restaurante casual, te devolvemos el 100% de tu dinero. Sin preguntas, sin complicaciones. Tienes 30 días para decidir.
          </p>
        </FadeIn>
        <FadeIn delay={150}>
