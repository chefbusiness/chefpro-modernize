...
const reasons = [
  ...
  },
  {
    ...
    desc: 'Inversión real (150K-350K€), food cost 28-32%, salarios España 2026, break-even calculado y 3 escenarios financieros.',
  },
  {
    icon: FileSpreadsheet,
    title: 'Incluye Plantillas por Valor de 80€+',
    desc: 'Plan financiero, escandallos, menú engineering, cronograma Gantt, turnos y más — todo en Excel con fórmulas automáticas.',
  },
  {
    icon: RefreshCw,
  ...
  return (
    <section className="py-16 md:py-24 px-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]">
        <img src="/lovable-uploads/ai-gallery/guia-casual-cocina.jpg" alt="" className="w-full h-full object-cover" loading="lazy" />
      </div>
