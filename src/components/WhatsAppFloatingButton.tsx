  ...
  return (
    ...
    >
      ...
      <div className="relative transition-transform duration-300 hover:scale-110">
        ...
        {/* Profile Image */}
        <div className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-full border-3 border-white shadow-xl overflow-hidden bg-white">
          <img
            src={chefProfile}
        ...
        <div className="absolute -bottom-1 -right-1 w-6 h-6 sm:w-7 sm:h-7 bg-green-500 rounded-full flex items-center justify-center shadow-lg border-2 border-white">
          <svg
            viewBox="0 0 24 24"
            fill="white"
