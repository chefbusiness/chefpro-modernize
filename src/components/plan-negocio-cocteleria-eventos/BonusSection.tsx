      ...
      <div className="max-w-5xl mx-auto">
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg">Además del plan financiero y los 7 entregables principales, accedes a estos recursos extra — valorados en €68</p>
          </div>
        </FadeIn>
        ...
        <FadeIn>
          <div className="text-center bg-white/5 border border-[#FFD700]/30 rounded-2xl p-8">
            ...
            <p className="text-5xl md:text-6xl font-extrabold text-[#FFD700] mb-2">€55</p>
            <p className="text-[#FFD700] font-bold text-lg">¡Ahorra €110 HOY!</p>
          </div>
        </FadeIn>
      </div>
    </section>
