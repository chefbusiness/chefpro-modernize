...
const bonuses = [
  {
    ...
    image: '/lovable-uploads/ai-gallery/aceitunas-liquidas.jpeg',
  },
  {
    icon: BookOpen,
    label: 'BONUS 2',
        ...
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg">
              Además del eBook en PDF, accederás a un <span className="text-white font-medium">dashboard exclusivo</span> con todos los prompts, bonos y herramientas — valorado en €97
            </p>
          </div>
        </FadeIn>
