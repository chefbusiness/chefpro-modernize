...
const TEMPLATES = [
  ...
  { key: 'plagas', icon: Bug, title: 'Control de Plagas (DDD)', desc: 'Registro de actuaciones DDD con certificados y calendario.' },
  { key: 'alergenos', icon: AlertTriangle, title: 'Matriz de Alérgenos', desc: 'Los 14 alérgenos × platos de tu carta con desplegables S/T/N.' },
...
export default function PackAppccDashboard() {
  const { token } = useAuth('pack-appcc-jwt');
  ...
  return (
    <>
      <Helmet>
        <title>Pack de Plantillas APPCC — Dashboard | AI Chef Pro</title>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="/pack-appcc" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
        ...
        <ProductChangelog productId="pack-appcc" />
        {/* ── Cross-sell banners ──────────────────────────────── */}
        ...
        <footer className="py-8 px-4 border-t border-white/10">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-500 text-sm mb-2">
              © 2026 AI Chef Pro · Pack de Plantillas APPCC · Todos los derechos reservados
            </p>
