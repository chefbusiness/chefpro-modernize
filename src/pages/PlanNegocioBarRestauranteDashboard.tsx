...
export default function PlanNegocioBarRestauranteDashboard() {
  const { token } = useAuth('plan-negocio-bar-restaurante-jwt');
  ...
  return (
    <>
      <Helmet>
        <title>Plan de Negocio Bar-Restaurante — Dashboard | AI Chef Pro</title>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="/plan-negocio-bar-restaurante" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm"><ArrowLeft className="w-4 h-4" />Plan de Negocio Bar-Restaurante</a>
        ...
        <footer className="py-8 px-4 border-t border-white/10">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-500 text-sm mb-2">© 2026 AI Chef Pro · Plan de Negocio Bar-Restaurante · Todos los derechos reservados</p>
