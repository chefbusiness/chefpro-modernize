...
const SECTIONS = [
  ...
  },
  {
    ...
    templates: [
      ...
      { key: 'calculadora-capex', icon: Calculator, title: 'Calculadora CAPEX', desc: 'Desglose inversión 120K-280K€: obra, cocina mexicana, sala, barra tequilas.', ext: '.xlsx' },
      ...
      { key: 'escandallo-maestro', icon: Flame, title: 'Escandallos: 15 Recetas Mexicanas', desc: 'Tacos al pastor, carnitas, guacamole, mole, enchiladas, churros y más.', ext: '.xlsx' },
      ...
      { key: 'calculadora-ticket', icon: Utensils, title: 'Calculadora Ticket Medio', desc: 'Simulador de escenarios: tacos + bebidas + extras.', ext: '.xlsx' },
      { key: 'cronograma-gantt', icon: Calendar, title: 'Cronograma Apertura Gantt 12 Meses', desc: '22 tareas con fases específicas para restaurante mexicano.', ext: '.xlsx' },
      { key: 'plantilla-turnos', icon: Users, title: 'Plantilla Turnos Brigada', desc: 'Cuadrante semanal para 14 personas con turnos y coste.', ext: '.xlsx' },
    ],
  },
  {
    title: 'Checklists (6)',
    templates: [
      { key: 'checklist-legal', icon: Scale, title: 'Checklist Legal Completo', desc: '32 trámites: licencias, importación, registro sanitario, CCAA.', ext: '.xlsx' },
      { key: 'checklist-equipamiento', icon: Wrench, title: 'Checklist Equipamiento Cocina Mexicana', desc: '35 ítems: comal, tortillera, ahumador, molcajete, máquina margaritas.', ext: '.xlsx' },
      { key: 'checklist-appcc', icon: ShieldCheck, title: 'Checklist APPCC', desc: '33 prerrequisitos adaptados a cocina mexicana e importación.', ext: '.xlsx' },
      { key: 'checklist-sala', icon: Layout, title: 'Checklist Diseño Sala Mexicana', desc: '30 ítems: interiorismo, azulejos Talavera, barra tequilas, terraza.', ext: '.xlsx' },
      { key: 'checklist-contratacion', icon: Users, title: 'Checklist Contratación', desc: '24 ítems: perfiles, taquero, parrillero, barman de cócteles.', ext: '.xlsx' },
      { key: 'checklist-marketing', icon: Megaphone, title: 'Checklist Marketing Pre-Apertura', desc: '25 acciones: Día de Muertos, Cinco de Mayo, redes, delivery.', ext: '.xlsx' },
    ],
  },
  {
    ...
    templates: [
      ...
      { key: 'manual-operaciones', icon: ChefHat, title: 'Manual de Operaciones Mexicano', desc: 'Apertura, cierre, servicio, salsas, taquería, barra de tequilas.', ext: '.docx' },
    ],
  },
];

export default function GuiaRestauranteMexicanoDashboard() {
  const { token } = useAuth('guia-restaurante-mexicano-jwt');
  ...
  return (
    <>
      <Helmet>
        <title>Guía Restaurante Mexicano — Dashboard | AI Chef Pro</title>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="/guia-restaurante-mexicano" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm"><ArrowLeft className="w-4 h-4" />Guía Restaurante Mexicano</a>
        ...
        <section className="py-12 md:py-16 px-4 text-center">
          <LogoBadge />
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-3 mt-4">Restaurante <span className="text-[#FFD700]">Mexicano</span></h1>
          <div className="mb-3">
            <ProductVersionBadge productId="guia-restaurante-mexicano" />
          </div>
        ...
        <ProductChangelog productId="guia-restaurante-mexicano" />
        <section className="py-10 px-4 border-t border-white/10">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="/guia-restaurante-casual" className="inline-block px-6 py-3 border border-[#FFD700]/50 text-[#FFD700] font-bold rounded-xl hover:bg-[#FFD700]/10 transition-all text-sm">Guía Restaurante Casual — 65 EUR</a>
        ...
        <footer className="py-8 px-4 border-t border-white/10">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-500 text-sm mb-2">© 2026 AI Chef Pro · Guía Restaurante Mexicano · Todos los derechos reservados</p>
          </div>
        </footer>
