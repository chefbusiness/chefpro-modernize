...
const TEMPLATES = [
  { key: 'apertura-cierre', icon: ChefHat, title: 'Apertura y Cierre', desc: 'Checklists completos: cocina, pass, sala, bodega, mise en place.' },
  { key: 'mise-en-place', icon: Beaker, title: 'Mise en Place Degustacion', desc: 'Preparacion de cada pase: bases, salsas, timing, temperaturas.' },
  { key: 'id-menu', icon: FlaskConical, title: 'I+D y Desarrollo de Menu', desc: 'Fichas tecnicas, pruebas, evaluacion sensorial, costes I+D.' },
  { key: 'brigada', icon: Users, title: 'Tareas por Brigada Creativa', desc: 'Chef ejecutivo, sous-chef, jefe de partida, commis, pastelero.' },
  { key: 'periodicas', icon: CalendarDays, title: 'Semanales y Mensuales', desc: 'Deep clean, inventario, reunion creativa, actualizacion carta.' },
  { key: 'sumiller', icon: Wine, title: 'Sumiller y Maridajes', desc: 'Bodega, carta de vinos, maridajes por pase, catas de equipo.' },
...
export default function KitTareasRestauranteCreativoDashboard() {
  const { token } = useAuth('kit-tareas-restaurante-creativo-jwt');
  ...
  return (
    <>
      <Helmet>
        <title>Kit de Tareas Restaurante Creativo — Dashboard | AI Chef Pro</title>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="/kit-tareas-restaurante-creativo" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm"><ArrowLeft className="w-4 h-4" />Kit de Tareas Restaurante Creativo</a>
        ...
        <section className="py-12 md:py-16 px-4 text-center">
          <LogoBadge />
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-3 mt-4">Kit de Tareas <span className="text-[#FFD700]">Restaurante Creativo / De Autor</span></h1>
          <div className="mb-3">
            <ProductVersionBadge productId="kit-tareas-restaurante-creativo" />
          </div>
          <p className="text-gray-400 text-base md:text-lg max-w-2xl mx-auto">Tus 9 checklists + 2 bonus operativos listos para descargar. Imprime, delega y controla.</p>
        </section>
        ...
        <ProductChangelog productId="kit-tareas-restaurante-creativo" />
        ...
        <footer className="py-8 px-4 border-t border-white/10">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-500 text-sm mb-2">© 2026 AI Chef Pro · Kit de Tareas Restaurante Creativo · Todos los derechos reservados</p>
