...
const UI: Record<string, {
  ...
  es: {
    ...
    finalBody: 'Empieza gratis y descubre cómo encaja en tu día a día. Sin tarjeta, 10.000 créditos al mes para probar todas las herramientas.',
  ...
  en: {
    ...
    finalBody: 'Start free and discover how it fits your day-to-day. No credit card. 10,000 credits per month to try every tool.',
