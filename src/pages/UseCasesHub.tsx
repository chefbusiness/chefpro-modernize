...
const UI: Record<string, {
  ...
  es: {
    ...
    finalBody: 'Empieza con el plan Miembro (10 €/mes, 10.000 créditos) y descubre cómo encaja en tu día a día. Sin permanencia.',
  ...
  en: {
    ...
    finalBody: 'Start with the Member plan (€10/month, 10,000 credits) and discover how it fits your day-to-day. No commitment.',
