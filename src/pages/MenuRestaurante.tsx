...
import { CheckCircle, ArrowRight, ChefHat, BookOpen, Utensils, FileText, Star, Layers } from 'lucide-react';
...
const TOOL_CARDS = [
  { icon: <BookOpen className="h-7 w-7 text-emerald-600" />, bg: 'bg-emerald-50', border: 'border-emerald-200' },
  { icon: <Star className="h-7 w-7 text-amber-600" />, bg: 'bg-amber-50', border: 'border-amber-200' },
  { icon: <Utensils className="h-7 w-7 text-blue-600" />, bg: 'bg-blue-50', border: 'border-blue-200' },
  { icon: <FileText className="h-7 w-7 text-purple-600" />, bg: 'bg-purple-50', border: 'border-purple-200' },
  { icon: <Layers className="h-7 w-7 text-orange-600" />, bg: 'bg-orange-50', border: 'border-orange-200' },
  { icon: <ChefHat className="h-7 w-7 text-teal-600" />, bg: 'bg-teal-50', border: 'border-teal-200' },
];
...
export default function MenuRestaurante() {
  ...
  const k = (key: string) => t(`landingMenu.${key}`, { returnObjects: true, userCount });
  const s = (key: string) => t(`landingMenu.${key}`, { userCount }) as string;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <PricingV2 medium="landing-carta-menu" />
        ...
        {/* CTA final */}
        <section className="py-20 bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-400">
