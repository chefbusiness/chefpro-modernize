...
const FormacionPresencial = () => {
  ...
  const valueItems = [
    { icon: Star, text: 'Acceso a AI Chef Pro (55+ herramientas de IA gastronómica)', color: 'amber' },
    { icon: BookOpen, text: 'Material formativo físico y digital', color: 'blue' },
    { icon: FileText, text: 'Biblioteca de prompts profesionales', color: 'emerald' },
    { icon: Award, text: 'Certificación oficial AI Chef Pro Academy', color: 'purple' },
    { icon: Headphones, text: 'Soporte post-formación incluido', color: 'pink' },
    { icon: Shield, text: 'Posibilidad de bonificación FUNDAE', color: 'teal' }
  ];
  ...
  const trainingImages = [
    { src: formacionWorkshop, alt: 'Workshop intensivo de IA para chefs profesionales', caption: 'Workshop Intensivo' },
    { src: formacionConferencia, alt: 'Conferencia magistral AI Chef Pro', caption: 'Conferencia Magistral' },
    { src: formacionPractica, alt: 'Sesión práctica de IA en cocina profesional', caption: 'Formación Práctica' },
    { src: formacionInhouse, alt: 'Consultoría in-house en restaurante', caption: 'Consultoría In-House' },
  ];

  const getColorClasses = (color: string) => {
    const colors: Record<string, { bg: string; iconBg: string; text: string; border: string }> = {
      emerald: { bg: 'bg-emerald-50', iconBg: 'bg-emerald-500/20', text: 'text-emerald-600', border: 'border-emerald-500/30' },
      amber: { bg: 'bg-amber-50', iconBg: 'bg-amber-500/20', text: 'text-amber-600', border: 'border-amber-500/30' },
      blue: { bg: 'bg-blue-50', iconBg: 'bg-blue-500/20', text: 'text-blue-600', border: 'border-blue-500/30' },
      purple: { bg: 'bg-purple-50', iconBg: 'bg-purple-500/20', text: 'text-purple-600', border: 'border-purple-500/30' },
      pink: { bg: 'bg-pink-50', iconBg: 'bg-pink-500/20', text: 'text-pink-600', border: 'border-pink-500/30' },
      teal: { bg: 'bg-teal-50', iconBg: 'bg-teal-500/20', text: 'text-teal-600', border: 'border-teal-500/30' },
    };
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
                ...
                <Button size="lg" variant="outline" onClick={() => document.getElementById('servicios')?.scrollIntoView({ behavior: 'smooth' })} className="border-amber-500/50 hover:bg-amber-50">
            ...
            <div className="hidden lg:block">
              <div className="relative">
                ...
                <img 
                  ...
                  alt="Conferencia AI Chef Pro" 
                  className="relative rounded-2xl shadow-2xl border-4 border-white/50"
                />
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
            {benefits.map((benefit, index) => {
              ...
              return (
                <Card key={index} className={`text-center hover:shadow-lg transition-all hover:-translate-y-1 border-t-4 ${colors.border}`}>
                  <CardHeader>
          ...
          <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-6">
            {services.map((service) => {
              ...
              return (
                <Card 
                  key={service.id} 
                  className={`relative overflow-hidden hover:shadow-xl transition-all hover:-translate-y-1 bg-gradient-to-br ${colors.gradient} ${service.popular ? 'ring-2 ring-blue-500' : ''}`}
                >
                  {service.popular && (
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
            {targetAudience.map((audience, index) => {
              ...
              return (
                <Card key={index} className={`text-center hover:shadow-lg transition-all hover:-translate-y-1 group border-b-4 ${colors.border}`}>
                  <CardHeader>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {valueItems.map((item, index) => {
              ...
              return (
                <div key={index} className={`flex items-center gap-4 p-5 bg-white rounded-xl border shadow-sm hover:shadow-md transition-shadow ${colors.border}`}>
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea 
                              placeholder="Cuéntanos sobre tu organización, número de asistentes, fechas preferidas, necesidades específicas..." 
                    ...
                    <Button 
                      type="submit" 
                      size="lg" 
                      className="w-full bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white text-lg"
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                className="text-lg px-8 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white"
              >
                <Send className="mr-2 h-5 w-5" />
