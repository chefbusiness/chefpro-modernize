...
import {
  ...
  DoorOpen, ChefHat, ClipboardList, Users,
...
// ── Template metadata ────────────────────────────────────────────
const TEMPLATES = [
  { key: 'apertura-cierre', icon: DoorOpen, title: 'Apertura y Cierre', desc: '6 checklists: apertura y cierre de cocina, sala y barra.' },
...
export default function KitTareasDashboard() {
  const { token } = useAuth('kit-tareas-jwt');
  ...
  return (
    <>
      <Helmet>
        <title>Kit de Tareas Recurrentes Pro — Dashboard | AI Chef Pro</title>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="/kit-tareas" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
        ...
        <section className="py-12 md:py-16 px-4 text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-3">
            Kit de Tareas <span className="text-[#FFD700]">Recurrentes Pro</span>
          </h1>
          <div className="mb-3">
        ...
        <ProductChangelog productId="kit-tareas" />
        {/* ── Cross-sell banners ──────────────────────────────── */}
        ...
        <footer className="py-8 px-4 border-t border-white/10">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-500 text-sm mb-2">
              © 2026 AI Chef Pro · Kit de Tareas Recurrentes Pro · Todos los derechos reservados
            </p>
