...
const TEMPLATES = [
  { key: 'apertura-cierre', icon: CakeSlice, title: 'Apertura y Cierre', desc: 'Checklists completos: vitrina, mostrador, obrador, caja, limpieza.' },
  { key: 'partidas', icon: Beaker, title: 'Partidas de Producción', desc: 'Templado, moldeado, bombones, tabletas, envasado, control calidad.' },
  { key: 'manager', icon: ClipboardList, title: 'Tareas del Manager', desc: 'Diario, semanal, mensual + food cost.' },
  { key: 'perfiles', icon: Users, title: 'Tareas por Perfil', desc: 'Chocolatero, dependiente, encargado de turno.' },
...
export default function KitTareasChocolateriaDashboard() {
  const { token } = useAuth('kit-tareas-chocolateria-jwt');
  ...
  return (
    <>
      <Helmet>
        <title>Kit de Tareas Chocolatería — Dashboard | AI Chef Pro</title>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="/kit-tareas-chocolateria" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm"><ArrowLeft className="w-4 h-4" />Kit de Tareas Chocolatería</a>
        ...
        <section className="py-12 md:py-16 px-4 text-center">
          <LogoBadge />
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-3 mt-4">Kit de Tareas <span className="text-[#FFD700]">Chocolatería Artesanal</span></h1>
          <div className="mb-3">
            <ProductVersionBadge productId="kit-tareas-chocolateria" />
          </div>
        ...
        <ProductChangelog productId="kit-tareas-chocolateria" />
        <section className="py-10 px-4 border-t border-white/10">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="/kit-tareas-heladeria" className="inline-block px-6 py-3 border border-[#FFD700]/50 text-[#FFD700] font-bold rounded-xl hover:bg-[#FFD700]/10 transition-all text-sm">Ver Kit Tareas Heladería — €12</a>
        ...
        <footer className="py-8 px-4 border-t border-white/10">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-500 text-sm mb-2">© 2026 AI Chef Pro · Kit de Tareas Chocolatería · Todos los derechos reservados</p>
