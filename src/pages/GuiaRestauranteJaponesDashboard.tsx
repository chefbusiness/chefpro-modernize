...
const SECTIONS = [
  ...
  },
  {
    ...
    templates: [
      ...
      { key: 'calculadora-capex', icon: Calculator, title: 'Calculadora CAPEX', desc: 'Desglose inversión 250K-500K€: obra, cocina japonesa, sala, barra sake.', ext: '.xlsx' },
      ...
      { key: 'escandallo-maestro', icon: Flame, title: 'Escandallos: 15 Recetas Japonesas', desc: 'Sashimi, nigiri, ramen tonkotsu, yakitori wagyu, tempura, katsu y más.', ext: '.xlsx' },
      ...
      { key: 'calculadora-ticket', icon: Utensils, title: 'Calculadora Ticket Medio', desc: 'Simulador con margen de sake y whisky japonés incluido.', ext: '.xlsx' },
      { key: 'cronograma-gantt', icon: Calendar, title: 'Cronograma Apertura Gantt 12 Meses', desc: '28 tareas con fases específicas (búsqueda itamae, anisakis).', ext: '.xlsx' },
      { key: 'plantilla-turnos', icon: Users, title: 'Plantilla Turnos Brigada', desc: 'Cuadrante semanal para 14 personas (itamae, sushi chef, ramen, robata).', ext: '.xlsx' },
    ],
  },
  {
    title: 'Checklists (6)',
    templates: [
      ...
      { key: 'checklist-equipamiento', icon: Wrench, title: 'Checklist Equipamiento Cocina Japonesa', desc: '36 ítems: suihanki, vitrina sashimi, ramen cooker, robata, cuchillos.', ext: '.xlsx' },
      { key: 'checklist-appcc', icon: ShieldCheck, title: 'Checklist APPCC (Pescado Crudo + Anisakis)', desc: '46 prerrequisitos: anisakis, shari, caldos ramen, tempura.', ext: '.xlsx' },
      { key: 'checklist-sala', icon: Layout, title: 'Checklist Diseño Sala Japonesa', desc: '32 ítems: madera, noren, washi, jardín zen, barra sushi, barra sake.', ext: '.xlsx' },
      { key: 'checklist-contratacion', icon: Users, title: 'Checklist Contratación', desc: '31 ítems: itamae, sushi chef, ramen cook, robata, sommelier sake.', ext: '.xlsx' },
      { key: 'checklist-marketing', icon: Megaphone, title: 'Checklist Marketing Pre-Apertura', desc: '31 acciones: Hanami, Día del Sushi, fotos premium, delivery.', ext: '.xlsx' },
    ],
  },
  {
    ...
    templates: [
      ...
      { key: 'manual-operaciones', icon: ChefHat, title: 'Manual de Operaciones Japonés', desc: 'Barra sushi, ramen, robata, barra sake, protocolo anisakis, delivery.', ext: '.docx' },
    ],
  },
];

export default function GuiaRestauranteJaponesDashboard() {
  const { token } = useAuth('guia-restaurante-japones-jwt');
  ...
  return (
    <>
      <Helmet>
        <title>Guía Restaurante Japonés — Dashboard | AI Chef Pro</title>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="/guia-restaurante-japones" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm"><ArrowLeft className="w-4 h-4" />Guía Restaurante Japonés</a>
        ...
        <section className="py-12 md:py-16 px-4 text-center">
          <LogoBadge />
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-3 mt-4">Restaurante <span className="text-[#FFD700]">Japonés</span></h1>
          <div className="mb-3">
            <ProductVersionBadge productId="guia-restaurante-japones" />
          </div>
        ...
        <ProductChangelog productId="guia-restaurante-japones" />
        ...
        <footer className="py-8 px-4 border-t border-white/10">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-500 text-sm mb-2">© 2026 AI Chef Pro · Guía Restaurante Japonés · Todos los derechos reservados</p>
          </div>
        </footer>
