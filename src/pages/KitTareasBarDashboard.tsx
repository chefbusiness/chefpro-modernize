...
const TEMPLATES = [
  ...
  { key: 'partidas', icon: Wine, title: 'Partidas de Barra', desc: 'Coctelería clásica, cerveza grifo, vinos por copa, bodega.' },
  { key: 'manager', icon: ClipboardList, title: 'Tareas del Manager', desc: 'Diario, semanal, mensual + briefing.' },
  { key: 'perfiles', icon: Users, title: 'Tareas por Perfil', desc: 'Head bartender, bartender, barback, camarero.' },
...
export default function KitTareasBarDashboard() {
  const { token } = useAuth('kit-tareas-bar-jwt');
  ...
  return (
    <>
      <Helmet>
        <title>Kit de Tareas Bar — Dashboard | AI Chef Pro</title>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="/kit-tareas-bar" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm"><ArrowLeft className="w-4 h-4" />Kit de Tareas Bar</a>
        ...
        <section className="py-12 md:py-16 px-4 text-center">
          <LogoBadge />
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-3 mt-4">Kit de Tareas <span className="text-[#FFD700]">Bar / Cocktails</span></h1>
          <div className="mb-3">
            <ProductVersionBadge productId="kit-tareas-bar" />
          </div>
        ...
        <ProductChangelog productId="kit-tareas-bar" />
