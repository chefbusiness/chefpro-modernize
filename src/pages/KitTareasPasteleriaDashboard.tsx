...
const TEMPLATES: TemplateCard[] = [
  { key: 'apertura-cierre', icon: DoorOpen, title: 'Apertura y Cierre', desc: '2 checklists (apertura y cierre del obrador) con 6 bloques y 42 tareas: equipos, preparación del obrador y vitrina/despacho.' },
  ...
  { key: 'eventos', icon: PartyPopper, title: 'Eventos y Festivos', desc: 'Navidad y Reyes, San Valentín, Semana Santa, Día de la Madre y del Padre, comuniones y Todos los Santos, con post-campaña.' },
