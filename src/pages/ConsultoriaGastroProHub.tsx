...
const UI: Record<string, {
  ...
  es: {
    ...
    ctaNote: '10.000 créditos/mes · Plan Miembro 10 €/mes',
    ...
    finalBody: 'Empieza con el onboarding de 2 minutos. Plan Miembro por 10 € al mes con 10.000 créditos para usar todos los agentes de Consultoría Gastro Pro.',
    finalCta: 'Probar ahora',
  ...
  en: {
    ...
    ctaNote: '10,000 credits/month · Member plan €10/month',
    ...
    finalBody: 'Start with our 2-minute onboarding. Member plan at €10/month with 10,000 credits to use every Gastro Consultancy Pro agent.',
    finalCta: 'Try it now',
  ...
  fr: {
    ...
    ctaNote: '10 000 crédits/mois · Plan Membre 10 €/mois',
    ...
    finalBody: 'Démarrez avec l\'onboarding de 2 minutes. Plan Membre à 10 € par mois avec 10 000 crédits pour utiliser tous les agents de Conseil Gastro Pro.',
    finalCta: 'Tester maintenant',
  ...
  de: {
    ...
    ctaNote: '10.000 Credits/Monat · Mitglied-Plan 10 €/Monat',
  ...
  it: {
    ...
    ctaNote: '10.000 crediti/mese · Piano Membro 10 €/mese',
    ...
    finalBody: 'Inizia con l\'onboarding di 2 minuti. Piano Membro a 10 € al mese con 10.000 crediti per usare tutti gli agenti di Consulenza Gastro Pro.',
    finalCta: 'Prova ora',
  ...
  pt: {
    ...
    ctaNote: '10.000 créditos/mês · Plano Membro 10 €/mês',
    ...
    finalBody: 'Comece com o onboarding de 2 minutos. Plano Membro por 10 € ao mês com 10.000 créditos para usar todos os agentes de Consultoria Gastro Pro.',
    finalCta: 'Testar agora',
  ...
  nl: {
    ...
    ctaNote: '10.000 credits/maand · Lid-plan €10/maand',
    ...
    finalBody: 'Start met de 2-minuten onboarding. Lid-plan voor €10 per maand met 10.000 credits om alle agenten van Gastro Advies Pro te gebruiken.',
    finalCta: 'Probeer nu',
