...
const UI: Record<string, {
  ...
  es: {
    ...
    ctaNote: '10.000 créditos gratis al mes · Sin tarjeta',
    ...
    finalBody: 'Empieza gratis con el onboarding de 2 minutos. 10.000 créditos al mes para probar todos los agentes de Consultoría Gastro Pro. Sin tarjeta.',
    ...
    faqs: [
      ...
      { q: '¿Cuánto cuesta empezar a usar la IA para consultoría gastronómica?', a: 'Puedes empezar gratis: 10.000 créditos al mes para probar todos los agentes de Consultoría Gastro Pro, sin tarjeta de crédito. El onboarding tarda unos 2 minutos.' },
    ],
  ...
  en: {
    ...
    ctaNote: '10,000 free credits per month · No credit card',
    ...
    finalBody: 'Start free with our 2-minute onboarding. 10,000 credits per month to try every Gastro Consultancy Pro agent. No credit card.',
    ...
    faqs: [
      ...
      { q: 'How much does it cost to start?', a: 'You can start free: 10,000 credits per month to try every Gastro Consultancy Pro agent, no credit card required. Onboarding takes about 2 minutes.' },
    ],
  ...
  fr: {
    ...
    ctaNote: '10 000 crédits gratuits/mois · Sans carte bancaire',
    ...
    finalBody: 'Démarrez gratuitement avec l\'onboarding de 2 minutes. 10 000 crédits par mois pour tester tous les agents de Conseil Gastro Pro. Sans carte bancaire.',
  ...
  de: {
    ...
    ctaNote: '10.000 kostenlose Credits/Monat · Keine Kreditkarte',
  ...
  it: {
    ...
    ctaNote: '10.000 crediti gratis/mese · Senza carta',
    ...
    finalBody: 'Inizia gratis con l\'onboarding di 2 minuti. 10.000 crediti al mese per provare tutti gli agenti di Consulenza Gastro Pro. Senza carta di credito.',
    ...
    faqs: [
      ...
      { q: "Quanto costa iniziare a usare l’IA per la consulenza di ristorazione?", a: "Puoi iniziare gratis: 10.000 crediti al mese per provare tutti gli agenti di Consulenza Gastro Pro, senza carta di credito. L’onboarding richiede circa 2 minuti." },
    ],
  ...
  pt: {
    ...
    ctaNote: '10.000 créditos grátis/mês · Sem cartão',
    ...
    finalBody: 'Comece grátis com o onboarding de 2 minutos. 10.000 créditos por mês para testar todos os agentes de Consultoria Gastro Pro. Sem cartão de crédito.',
    ...
    faqs: [
      ...
      { q: "Quanto custa começar a usar a IA para consultoria gastronômica?", a: "Pode começar gratuitamente: 10.000 créditos por mês para experimentar todos os agentes do Consultoria Gastro Pro, sem necessidade de cartão de crédito. O onboarding demora cerca de 2 minutos. Após o período de testes, pode escolher um plano que se ajuste ao volume de projetos." },
    ],
  ...
  nl: {
    ...
    ctaNote: '10.000 gratis credits/maand · Geen creditcard',
    ...
    finalBody: 'Start gratis met de 2-minuten onboarding. 10.000 credits per maand om alle agenten van Gastro Advies Pro te testen. Geen creditcard nodig.',
    ...
    faqs: [
      ...
      { q: "Wat kost het om te starten met deze AI voor horeca advies?", a: "Je start gratis. Met 10.000 gratis credits per maand kun jij alle agenten van Consultancy Gastro Pro testen, zonder creditcard en binnen een onboarding van ongeveer 2 minuten." },
    ],
    seoTitle: "Horeca Consultant AI: Adviseer Sneller | AI Chef Pro",
    seoDescription: "Horeca consultant AI met 10 specialisten. Versnel als restaurant consultant of culinair adviseur je projecten. Start nu met 10.000 gratis credits per maand.",
