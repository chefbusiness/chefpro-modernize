...
import {
  ...
  IceCream, Beaker, ClipboardList, Users,
  CalendarDays, Sun, FileEdit, Megaphone, Calendar, Building2, Wallet,
} from 'lucide-react';
...
const TEMPLATES = [
  { key: 'apertura-cierre', icon: IceCream, title: 'Apertura y Cierre', desc: 'Checklists completos: vitrina, toppings, caja, limpieza.' },
  { key: 'partidas', icon: Beaker, title: 'Partidas de Producción', desc: 'Pasteurización, mantecación, envasado, control calidad.' },
  { key: 'manager', icon: ClipboardList, title: 'Tareas del Manager', desc: 'Diario, semanal, mensual + food cost.' },
  { key: 'perfiles', icon: Users, title: 'Tareas por Perfil', desc: 'Heladero, dependiente, encargado de turno.' },
  { key: 'periodicas', icon: CalendarDays, title: 'Semanales y Mensuales', desc: 'Deep clean obrador, mantenimiento, inventario.' },
  { key: 'eventos', icon: Sun, title: 'Eventos y Temporada', desc: 'Carta estacional, catering, fechas clave.' },
  { key: 'personalizable', icon: FileEdit, title: 'Plantilla Personalizable', desc: '3 plantillas en blanco para crear las tuyas.' },
  { key: 'apertura-negocio', icon: Building2, title: 'Apertura y Cierre del Negocio', desc: 'Checklist completo para abrir y cerrar la heladería.' },
  { key: 'apertura-caja', icon: Wallet, title: 'Apertura y Cierre de Caja', desc: 'Fondo de caja, arqueo, cuadre y depósito.' },
  { key: 'bonus-briefing', icon: Megaphone, title: 'BONUS: Briefing Diario', desc: 'Plantilla de briefing diario de heladería.' },
  { key: 'bonus-calendario', icon: Calendar, title: 'BONUS: Calendario Anual', desc: '15 fechas clave para heladerías.' },
];

export default function KitTareasHeladeriaDashboard() {
  const { token } = useAuth('kit-tareas-heladeria-jwt');
  ...
  return (
    <>
      <Helmet>
        <title>Kit de Tareas Heladería — Dashboard | AI Chef Pro</title>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="/kit-tareas-heladeria" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm"><ArrowLeft className="w-4 h-4" />Kit de Tareas Heladería</a>
        ...
        <section className="py-12 md:py-16 px-4 text-center">
          <LogoBadge />
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-3 mt-4">Kit de Tareas <span className="text-[#FFD700]">Heladería Artesanal</span></h1>
          <div className="mb-3">
            <ProductVersionBadge productId="kit-tareas-heladeria" />
          </div>
        ...
        <ProductChangelog productId="kit-tareas-heladeria" />
        ...
        <footer className="py-8 px-4 border-t border-white/10">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-500 text-sm mb-2">© 2026 AI Chef Pro · Kit de Tareas Heladería · Todos los derechos reservados</p>
