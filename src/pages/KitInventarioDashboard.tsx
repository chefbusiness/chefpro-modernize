...
export default function KitInventarioDashboard() {
  const { token } = useAuth('kit-inventario-jwt');
  ...
  return (
    <>
      <Helmet>
        <title>Kit Control de Inventario y Compras — Dashboard | AI Chef Pro</title>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="/kit-inventario" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm"><ArrowLeft className="w-4 h-4" />Kit Inventario</a>
        ...
        <section className="py-12 md:py-16 px-4 text-center">
          <LogoBadge />
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-3 mt-4">Control de <span className="text-[#FFD700]">Inventario y Compras</span></h1>
          <div className="mb-3">
            <ProductVersionBadge productId="kit-inventario" />
          </div>
          <p className="text-gray-400 text-base md:text-lg max-w-2xl mx-auto">Tus 9 plantillas de control de inventario listas para descargar. Controla, reduce mermas y optimiza.</p>
        </section>
        ...
        <ProductChangelog productId="kit-inventario" />
        ...
        <footer className="py-8 px-4 border-t border-white/10">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-500 text-sm mb-2">© 2026 AI Chef Pro · Kit Control de Inventario y Compras · Todos los derechos reservados</p>
