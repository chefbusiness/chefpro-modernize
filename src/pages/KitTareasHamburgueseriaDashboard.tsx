...
// ── Template metadata ────────────────────────────────────────────
const TEMPLATES = [
  { key: 'apertura-cierre', icon: DoorOpen, title: 'Apertura y Cierre', desc: '6 checklists: apertura y cierre de plancha, freidora, línea, sala y barra.' },
  { key: 'plancha-grill', icon: Flame, title: 'Tareas de Plancha y Grill', desc: 'Encendido, temperatura, smash burger, punto de carne, limpieza.' },
  { key: 'manager', icon: ClipboardList, title: 'Tareas del Manager', desc: 'Diario, semanal, mensual + handover de turno.' },
  { key: 'perfiles', icon: Users, title: 'Tareas por Perfil', desc: 'Parrillero, cocinero línea, freidurista, encargado, camarero.' },
...
export default function KitTareasHamburgueseriaDashboard() {
  const { token } = useAuth('kit-tareas-hamburgueseria-jwt');
  ...
  return (
    <>
      <Helmet>
        <title>Kit de Tareas Hamburguesería — Dashboard | AI Chef Pro</title>
      ...
      <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <header className="sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            <a href="/kit-tareas-hamburgueseria" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm">
              <ArrowLeft className="w-4 h-4" />
              Kit de Tareas Hamburguesería
            </a>
        ...
        <section className="py-12 md:py-16 px-4 text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-3 mt-4">
            Kit de Tareas <span className="text-[#FFD700]">Hamburguesería</span>
          </h1>
          <div className="mb-3">
            <ProductVersionBadge productId="kit-tareas-hamburgueseria" />
          </div>
        ...
        <ProductChangelog productId="kit-tareas-hamburgueseria" />
        {/* ── Cross-sell banners ──────────────────────────────── */}
        <section className="py-10 px-4 border-t border-white/10">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                href="/kit-tareas-pizzeria"
                className="inline-block px-6 py-3 border border-[#FFD700]/50 text-[#FFD700] font-bold rounded-xl hover:bg-[#FFD700]/10 transition-all text-sm"
              >
                Ver Kit Tareas Pizzería — €12
              </a>
              <a
        ...
        <footer className="py-8 px-4 border-t border-white/10">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-500 text-sm mb-2">
              © 2026 AI Chef Pro · Kit de Tareas Hamburguesería · Todos los derechos reservados
            </p>
