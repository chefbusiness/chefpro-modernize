      ...
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "¿Qué normativa de anisakis aplica a tiraditos y leches de tigre?", "acceptedAnswer": { "@type": "Answer", "text": "El RD 1021/2022, art. 8.1 (que derogó el RD 1420/2006) OBLIGA a congelar preventivamente todo pescado para consumo crudo (incluidos tiraditos, ceviches nikkei y marinados en leche de tigre) a -20°C durante mínimo 24 horas en todo el producto, o -35°C durante 15 horas. La guía incluye PCC específico, checklist y protocolo de trazabilidad." }},
