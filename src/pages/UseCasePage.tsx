...
const UI: Record<string, {
  ...
  es: {
    ...
    ctaFreeUses: '3.000 créditos gratis al mes · Sin tarjeta',
  ...
  en: {
    ...
    ctaFreeUses: '3,000 free credits per month · No credit card',
  ...
  fr: {
    ...
    ctaFreeUses: '3 000 crédits gratuits/mois · Sans carte bancaire',
  ...
  de: {
    ...
    ctaFreeUses: '3.000 kostenlose Credits/Monat · Keine Kreditkarte',
  ...
  it: {
    ...
    ctaFreeUses: '3.000 crediti gratis/mese · Senza carta',
  ...
  pt: {
    ...
    ctaFreeUses: '3.000 créditos grátis/mês · Sem cartão',
  ...
  nl: {
    ...
    ctaFreeUses: '3.000 gratis credits/maand · Geen creditcard',
