...
const UI: Record<string, {
  ...
  fr: {
    ...
    ctaFreeUses: '5 usages gratuits/mois · Sans carte bancaire',
  ...
  de: {
    ...
    ctaFreeUses: '5 kostenlose Anwendungen/Monat · Keine Kreditkarte',
  ...
  it: {
    ...
    ctaFreeUses: '5 utilizzi gratis/mese · Senza carta',
  ...
  pt: {
    ...
    ctaFreeUses: '5 usos grátis/mês · Sem cartão',
  ...
  nl: {
    ...
    ctaFreeUses: '5 gratis gebruiken/maand · Geen creditcard',
