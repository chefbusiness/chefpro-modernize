...
const UI: Record<string, {
  ...
  es: {
    ...
    ctaFreeUses: '10.000 créditos gratis al mes · Sin tarjeta',
  ...
  en: {
    ...
    ctaFreeUses: '10,000 free credits per month · No credit card',
  ...
  fr: {
    ...
    ctaFreeUses: '10 000 crédits gratuits/mois · Sans carte bancaire',
  ...
  de: {
    ...
    ctaFreeUses: '10.000 kostenlose Credits/Monat · Keine Kreditkarte',
  ...
  it: {
    ...
    ctaFreeUses: '10.000 crediti gratis/mese · Senza carta',
  ...
  pt: {
    ...
    ctaFreeUses: '10.000 créditos grátis/mês · Sem cartão',
  ...
  nl: {
    ...
    ctaFreeUses: '10.000 gratis credits/maand · Geen creditcard',
