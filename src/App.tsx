...
import PlanNegocioTapasBar from "./pages/PlanNegocioTapasBar";
import PlanNegocioTapasBarAccessGate from "./pages/PlanNegocioTapasBarAccessGate";
import PlanNegocioTapasBarDashboard from "./pages/PlanNegocioTapasBarDashboard";
...
import GuiaRestauranteJapones from "./pages/GuiaRestauranteJapones";
import GuiaRestauranteJaponesAccessGate from "./pages/GuiaRestauranteJaponesAccessGate";
import GuiaRestauranteJaponesDashboard from "./pages/GuiaRestauranteJaponesDashboard";
import GuiaRestauranteNikkei from "./pages/GuiaRestauranteNikkei";
import GuiaRestauranteNikkeiAccessGate from "./pages/GuiaRestauranteNikkeiAccessGate";
import GuiaRestauranteNikkeiDashboard from "./pages/GuiaRestauranteNikkeiDashboard";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/kit-tareas-sushi-bar" element={<KitTareasSushiBar />} />
            <Route path="/kit-tareas-sushi-bar-access" element={<KitTareasSushiBarAccessGate />} />
            <Route
              path="/kit-tareas-sushi-bar-library"
              element={
            ...
            {/* Plan de Negocio Tapas Bar / Gastrobar */}
            <Route path="/plan-negocio-tapas-bar" element={<PlanNegocioTapasBar />} />
            <Route path="/plan-negocio-tapas-bar-access" element={<PlanNegocioTapasBarAccessGate />} />
            <Route
              path="/plan-negocio-tapas-bar-library"
              element={
            ...
            {/* Plan de Negocio Cafetería / Brunch */}
            <Route path="/plan-negocio-cafeteria" element={<PlanNegocioCafeteria />} />
            <Route path="/plan-negocio-cafeteria-access" element={<PlanNegocioCafeteriaAccessGate />} />
            <Route
              path="/plan-negocio-cafeteria-library"
              element={
            ...
            <Route path="/plan-negocio-food-truck" element={<PlanNegocioFoodTruck />} />
            <Route path="/plan-negocio-food-truck-access" element={<PlanNegocioFoodTruckAccessGate />} />
            <Route
              path="/plan-negocio-food-truck-library"
              element={
            ...
            <Route path="/kit-tareas-food-truck" element={<KitTareasFoodTruck />} />
            <Route path="/kit-tareas-food-truck-access" element={<KitTareasFoodTruckAccessGate />} />
            <Route
              path="/kit-tareas-food-truck-library"
              element={
            ...
            {/* Guía Restaurante Gastronómico */}
            <Route path="/guia-restaurante-gastronomico" element={<GuiaRestauranteGastronomico />} />
            <Route path="/guia-restaurante-gastronomico-access" element={<GuiaRestauranteGastronomicoAccessGate />} />
            <Route
              path="/guia-restaurante-gastronomico-library"
              element={
            ...
            {/* Guía Restaurante Japonés */}
            <Route path="/guia-restaurante-japones" element={<GuiaRestauranteJapones />} />
            <Route path="/guia-restaurante-japones-access" element={<GuiaRestauranteJaponesAccessGate />} />
            <Route
              path="/guia-restaurante-japones-library"
              element={
            ...
            {/* Guía Restaurante Nikkei */}
            <Route path="/guia-restaurante-nikkei" element={<GuiaRestauranteNikkei />} />
            <Route path="/guia-restaurante-nikkei-access" element={<GuiaRestauranteNikkeiAccessGate />} />
            <Route
              path="/guia-restaurante-nikkei-library"
              element={
                <ProtectedRoute storageKey="guia-restaurante-nikkei-jwt" redirectTo="/guia-restaurante-nikkei">
                  <GuiaRestauranteNikkeiDashboard />
                </ProtectedRoute>
              }
            />
