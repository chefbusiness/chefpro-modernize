...
<div data-id="1faedba7" class="wp-block-blocksy-query"><div class="ct-query-template-grid"><article class="wp-block-post is-layout-flow post-3965 post type-post status-publish format-standard has-post-thumbnail hentry category-ia-en-gastronomia category-ai-chef-pro">
...
</article></div><style>[data-id='1faedba7'] {--grid-columns-width:3;}@media (max-width: 999.98px) {[data-id='1faedba7'] {--grid-columns-width:2;}}@media (max-width: 689.98px) {[data-id='1faedba7'] {--grid-columns-width:1;}}</style></div>
