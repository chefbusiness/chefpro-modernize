...
const data: GuiaData = {
  ...
  grid: {
    ...
    subtitle: 'Todo lo que necesitas saber para montar tu restaurante mexicano en España, escrito por un profesional con 29 años en hostelería.',
    chapters: [
  ...
  why: {
    reasons: [
      { icon: 'UtensilsCrossed', title: 'Escrita por un Profesional', desc: '29 años en hostelería, 200+ aperturas asesoradas. Incluye proveedores reales de productos mexicanos en España.' },
  ...
  author: {
    bio: 'CEO de AI Chef Pro y fundador de ChefBusiness Group. Más de 29 años en alta hostelería y 15 años en consultoría gastronómica. Ha asesorado la apertura de más de 200 establecimientos en España y Europa, incluyendo restaurantes de cocina internacional y conceptos temáticos.',
