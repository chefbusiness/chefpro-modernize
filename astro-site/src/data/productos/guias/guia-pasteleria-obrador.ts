...
const data: GuiaData = {
  ...
  hero: {
    ...
    checkItems: [
      'Guía completa PDF + DOCX editable: 20 capítulos y un anexo normativo con fecha de corte (103 páginas)',
      ...
      'Bonus 2: 12 decisiones de apertura resueltas (37 páginas)',
    ],
  ...
  bonus: {
    ...
    // ítems (3+2) y con 10 dejaría 3 tarjetas anchas y 7 estrechas. Mismo criterio
    // que guia-food-cost-ingenieria-menu.ts, que también lista aquí sus herramientas.
    layout: 'single',
    items: [
      {
        icon: 'FileSpreadsheet',
        label: 'HERRAMIENTA 1',
        title: 'Capacidad de Obrador y Local',
        value: 'Incluido en el pack',
        desc: 'Zonas y metros cuadrados, capacidad por equipo, cuello de botella y ficha de visita al local con la prueba de humos. Decide si ese local sirve y cuántas piezas al día aguanta el equipo que estás a punto de comprar.',
      ...
      },
      {
        ...
        value: 'Incluido en el pack',
        desc: 'Inversión por bloque, variante del formato, traspaso frente a obra nueva, e impuesto y tesorería. Decide cuánto necesitas de verdad y si te sale mejor coger un traspaso o montarlo desde cero.',
        image: '/lovable-uploads/ai-gallery/guia-pasteleria-3.jpg',
      },
      {
        icon: 'CalendarRange',
        label: 'HERRAMIENTA 3',
        title: 'Estacionalidad y Picos del Año',
        value: 'Incluido en el pack',
        desc: 'Calendario de campañas, peso de cada una sobre el año, capacidad frente a demanda del pico, y refuerzo y tesorería. Decide si aguantas Reyes y cuánto dinero te inmoviliza cada campaña antes de venderla.',
        image: '/lovable-uploads/ai-gallery/guia-pasteleria-4.jpg',
      },
      {
        icon: 'Calculator',
        label: 'HERRAMIENTA 4',
        ...
        value: 'Incluido en el pack',
        desc: 'Escandallo por tanda de 30 referencias, coste de la hora de obrador y mano de obra, decisión de huevo y temperatura, mix y ticket medio, y decisión de surtido. Decide qué vendes, a cuánto y con qué vía legal.',
        image: '/lovable-uploads/ai-gallery/guia-pasteleria-1.jpg',
      },
      {
        icon: 'TrendingUp',
        label: 'HERRAMIENTA 5',
        ...
        value: 'Incluido en el pack',
        desc: 'Supuestos, inversión inicial, cuenta de resultados a tres años, punto de equilibrio, escenarios, personal, tesorería mes a mes, financiación y margen por canal. Decide si el negocio se sostiene y cuándo llega al equilibrio.',
        image: '/lovable-uploads/ai-gallery/guia-pasteleria-5.jpg',
      },
      {
        icon: 'ClipboardCheck',
        label: 'HERRAMIENTA 6',
        title: 'Checklist Legal y de Licencias',
        value: 'Incluido en el pack',
        desc: 'Seis fases con contador de avance, árbol de registro sanitario, árbol de la venta a otros comercios, ruta doméstica, registro de formación, y cronograma con ruta crítica. Decide qué papel te toca, en qué orden y cuándo abres.',
        image: '/lovable-uploads/ai-gallery/guia-pasteleria-3.jpg',
      },
      {
        icon: 'Wrench',
        label: 'HERRAMIENTA 7',
        title: 'Checklist de Equipamiento y Proveedores',
        value: 'Incluido en el pack',
        desc: 'Equipamiento con horquilla, prioridad, impuesto y plazo de entrega; variante del formato; proveedores verificados con su enlace; y contador. Decide qué compras, a quién, a qué precio real negociado y con qué plazo.',
        image: '/lovable-uploads/ai-gallery/guia-pasteleria-2.jpg',
      },
      {
        icon: 'Users',
        label: 'HERRAMIENTA 8',
        title: 'Turnos y Coste de Personal',
        value: 'Incluido en el pack',
        desc: 'Parámetros de convenio y seguridad social, turnos semanales, horas y coste, y plan de contratación. Decide cuánta gente necesitas, de qué perfil y cuánto cuesta de verdad con la seguridad social dentro.',
        image: '/lovable-uploads/ai-gallery/guia-pasteleria-4.jpg',
      },
      {
        icon: 'ScrollText',
        ...
        value: 'Incluido en el pack',
        desc: 'El caso completo de la pastelería de ejemplo en el formato que pide un banco o una línea de financiación pública: resumen ejecutivo, mercado y plaza, concepto y carta, plan de operaciones, plan financiero a tres años y riesgos con escenarios. En DOCX editable, con las cifras cuadradas contra el plan financiero del pack, celda a celda.',
        image: '/lovable-uploads/ai-gallery/guia-pasteleria-5.jpg',
      },
      {
        icon: 'GraduationCap',
  ...
  cta: {
    ...
    items: [
      'Guía completa PDF + DOCX: 20 capítulos y anexo normativo con fecha de corte (103 páginas)',
      ...
      'Bonus: business plan modelo relleno y 12 decisiones de apertura resueltas (37 páginas)',
    ],
    ctaLabel: 'SÍ, QUIERO LA GUÍA — 65 EUR',
  },
  ...
  updateNote: 'Versión 1.0.1 · septiembre 2026',
