...
const data: GuiaData = {
  ...
  faqs: [
    ...
    { q: '¿Este manual sirve si mi restaurante está fuera de España?', a: 'Sí, con un matiz que conviene decir claro antes de comprar: el bloque normativo está escrito con la ley española, y sus artículos y enlaces son españoles. Lo que viaja es todo lo demás, que es la mayor parte: el método de dirección, la manera de leer los números, los protocolos de servicio, las conversaciones difíciles y las siete herramientas, cuyos parámetros (tipos de cotización, umbrales, plazos, objetivos y periodicidades) viven en casillas editables para que sustituyas los valores por los de tu país. El vocabulario incluye las equivalencias de Hispanoamérica: gerente/encargado y administrador, cuadrante y rol de horario, arqueo y corte de caja, nómina y planilla, sala y salón.' },
  ...
  schema: {
    ...
    productDescription: 'Manual operativo de 20 capítulos para quien ya dirige un restaurante o un turno: operación del día, personas y jornada, números del turno, servicio y cumplimiento legal español verificado contra el BOE. Incluye 7 herramientas Excel con fórmulas vivas y un bonus de 12 situaciones resueltas.',
    price: '55.00',
    ...
    faqs: [
      ...
      { q: '¿Este manual sirve si mi restaurante está fuera de España?', a: 'El bloque normativo está escrito con la ley española y sus artículos citados. El método, los protocolos y las siete herramientas viajan: los parámetros legales viven en casillas editables para sustituirlos por los de cada país.' },
