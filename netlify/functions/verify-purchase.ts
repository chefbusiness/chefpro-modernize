...
export const PRODUCTS: Record<string, ProductConfig> = {
  ...
  'guia-pasteleria-obrador': {
    ...
    emailTitle: '¡Gracias por tu compra!',
    emailBody: 'Tu acceso a <strong>Cómo Montar una Pastelería</strong> está listo. Haz clic en el botón para acceder a tu dashboard y descargar la guía PDF + DOCX (20 capítulos y anexo normativo, __PAGINAS__ páginas), las 8 herramientas Excel con fórmulas vivas, el business plan modelo relleno y las 12 decisiones de apertura resueltas:<br /><br />El día que abras, lo que vas a usar cada mañana es el <a href="https://aichef.pro/kit-tareas-pasteleria?utm_source=email&amp;utm_medium=postpago&amp;utm_campaign=cross-sell" style="color: #b8860b;">Kit de Tareas Pastelería</a> (producción, encargos, alérgenos de vitrina y temperaturas). Para el papeleo diario de seguridad alimentaria está el <a href="https://aichef.pro/pack-appcc?utm_source=email&amp;utm_medium=postpago&amp;utm_campaign=cross-sell" style="color: #b8860b;">Pack de Plantillas APPCC</a>, para escandallar por formato el <a href="https://aichef.pro/kit-escandallos?utm_source=email&amp;utm_medium=postpago&amp;utm_campaign=cross-sell" style="color: #b8860b;">Kit de Escandallos Pro</a>, y cuando ya estés vendiendo y toque revisar precios y carta, la <a href="https://aichef.pro/guia-food-cost-ingenieria-menu?utm_source=email&amp;utm_medium=postpago&amp;utm_campaign=cross-sell" style="color: #b8860b;">Guía Food Cost + Ingeniería de Menú</a>.',
    emailCta: 'Acceder a mi Guía',
  },
