...
def mapa_celdas():
    m = [
        ...
        ('Bombones de obrador al día en crucero', H_PAR, P_PZOBR, 'entrada'),
        ...
        ('Días de campana al año', H_CAL, 'J%d' % FIL_TOT, 'salida'),
        ('Unidades incrementales de las doce campanas', H_CAL,
         'L%d' % FIL_TOT, 'salida'),
        ('Facturación de las doce campanas con IVA', H_CAL, 'M%d' % FIL_TOT,
         'salida'),
        ('Facturación de las doce campanas sin IVA', H_CAL, 'N%d' % FIL_TOT,
         'salida'),
        ('Facturación incremental de las doce campanas sin IVA', H_CAL,
         'O%d' % FIL_TOT, 'salida'),
        ...
        ('Peso de diciembre sobre el año', H_ANO, 'F%d' % FILA_MES[12],
         'salida'),
        ('Peso de agosto sobre el año', H_ANO, 'F%d' % FILA_VALLE, 'salida'),
        ('Veces un día medio que factura un día de diciembre', H_ANO,
         'H%d' % FILA_MES[12], 'salida'),
        ('Peso de las doce campanas sobre el año', H_ANO, 'D%d' % PIC_TOT,
         'salida'),
        ('Peso incremental de las doce campanas sobre el año', H_ANO,
         'F%d' % PIC_TOT, 'salida'),
        ('Capacidad diaria del obrador traida del libro 1', H_CAP, CAP_TRAE,
         'entrada'),
        ('Desviación del cuadre de capacidad', H_CAP, CAP_DESV, 'salida'),
        ('Veredicto del cuadre de capacidad', H_CAP, CAP_CUAD, 'salida'),
        ('Campanas que no aguanta el obrador', H_CAP, 'B%d' % CAP_NOAG,
         'salida'),
        ('Campanas con déficit después de adelantar', H_CAP,
         'B%d' % (CAP_NOAG + 1), 'salida'),
        ('Bombones de obrador extra de las doce campanas', H_CAP,
         'N%d' % CAP_TOT, 'salida'),
        ('Coste del refuerzo de todo el año', H_REF, 'E%d' % FIL_TOT,
         'salida'),
        ('Inversión en moldes de temporada del año', H_REF, 'G%d' % FIL_TOT,
         'salida'),
        ('Inversión en packaging de temporada del año', H_REF,
         'I%d' % FIL_TOT, 'salida'),
        ('Tesorería inmovilizada en campanas', H_REF, 'J%d' % FIL_TOT,
         'salida'),
        ...
        ('Bombones de obrador al año en crucero', H_VAL, 'B%d' % VC_ANO,
         'salida'),
        ('Las campanas sobre la producción del año', H_VAL, 'B%d' % VC_PCT,
         'salida'),
    ...
    for i, c in enumerate(CAMPANAS):
        ...
        nom = c['campana']
        m += [
            ('Facturación sin IVA de la campana de %s' % nom, H_CAL,
             'N%d' % cal, 'salida'),
            ('Demanda de bombones de obrador al día en %s' % nom, H_CAP,
             'F%d' % cap, 'salida'),
