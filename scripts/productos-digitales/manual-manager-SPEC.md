...
| D9 | **Datos del INE permitidos** con su etiqueta exacta: supervivencia de empresas de hostelería (INE, CNAE 55+56, cohorte 2018: 75,6 % a 1 año, 61,6 % a 2, 53,5 % a 3, 45,2 % a 4, 38,8 % a 5 — MM-55), absentismo de hostelería (ETCL tabla 6043), coste salarial hostelería vs media (17.190,75 € vs 28.410,78 €). **Sustituyen** a Linkers (1.512/2.345 €) y a cualquier cifra secundaria. La temporalidad se fecha (2T 2026) o no se escribe | A8, A10 |
...
| D17 | **Gates de documentos**: `paginas_prometidas: 75` (corregido el 2026-09-05: el primer ensamblado midió 77 páginas para 41.223 palabras, ≈ 530 palabras/página; la calibración de 330 de la refutación C4 era errónea), `min_palabras_cap: 1200`, ~30.000 palabras; bonus `paginas_prometidas: 25`, ~7.500 palabras. La landing publica las páginas **medidas** | C4 |
...
- Guía Food Cost (ya publicada): `FC-PRIME-01`/`FC-PRIME-02` atribuyen a Toast el prime cost 60-65 % (es de Laube/RestaurantOwner; Toast dice «60 % o menos») y `SMI-02` repite los 17.094 € sin acotar como cálculo propio → v1.1 de esa guía en una sesión impar.
