...
# -*- coding: utf-8 -*-
"""
_comun_pasteleria.py — utilidades de formato compartidas por los constructores
de los libros de «Cómo Montar una Pastelería».
...
#: la primera palabra del título (auditoría 2026-09-10, hallazgo A10).
...
def titulo_hoja(texto):
    ...
    conectores cortos en minúscula salvo en primera posición. Se aplica al A1
    ...
    for i, p in enumerate(palabras):
        ...
        if i and limpio in _MENORES_TC:
            out.append(p.lower())
        else:
