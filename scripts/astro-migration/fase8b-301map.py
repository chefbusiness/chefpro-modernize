...
def main():
    ...
    lines = [
        ...
        '',
        '# Hub librería (página WP 234) → el hub REAL, reconstruido en 8C (2026-07-31):',
        '# la archive de la categoría es un listado por fecha y perdía el sentido del original.',
        '%s/libreria-de-prompts %s/libreria-de-prompts 301!' % (HOST, DEST),
        '%s/libreria-de-prompts/* %s/libreria-de-prompts 301!' % (HOST, DEST),
        '',
